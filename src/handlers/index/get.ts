...
h1{font-size:2.5rem;display:flex;align-items:center;flex-wrap:wrap;gap:.75rem}
h1 img{flex-shrink:0;object-fit:contain}
...
<main>
<h1><img src="https://hanasand.com/hanasand-logo-transparent.png" alt="" width="72" height="72">Hanasand CDN</h1>
